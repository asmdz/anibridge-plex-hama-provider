...
class Video(PlexPartialObject, PlayedUnplayedMixin):
    ...
    def searchSubtitles(
        self, language: str = ..., hearingImpaired: int = ..., forced: int = ...
    ) -> list[SubtitleStream]: ...
    def downloadSubtitles(self, subtitleStream: SubtitleStream) -> Self: ...
    def removeSubtitles(
        self,
        subtitleStream: SubtitleStream | None = ...,
        streamID: int | None = ...,
        streamTitle: str | None = ...,
    ) -> Self: ...
    def optimize(
        self,
        title: str = ...,
...
class Show(
    ...
    def season(self, title: str | None = ..., season: int | None = ...) -> Season: ...
...
class Season(
    ...
    def onDeck(self) -> bool: ...
    def episode(
        self, title: str | None = ..., episode: int | None = ...
    ) -> Episode: ...
    def episodes(self, **kwargs) -> list[Episode]: ...
    def get(self, title: str | None = ..., episode: int | None = ...) -> Episode: ...
    def show(self) -> Show: ...
    def watched(self) -> list[Episode]: ...
    def unwatched(self) -> list[Episode]: ...
    def download(
